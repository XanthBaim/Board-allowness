var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Επίδομα σίτισης σπουδαστών/στριών των Ακαδημιών Εμπορικού Ναυτικού (ΑΕΝ)",
      pageTitle: "Δελτίο Μετακίνησης ΑΜΕΑΕπίδομα σίτισης σπουδαστών/στριών των Ακαδημιών Εμπορικού Ναυτικού (ΑΕΝ)",
      infoTitle: "Πληροφορίες για την χορήγηση επιδόματος σίτισης σπουδαστών/στριών των Ακαδημιών Εμπορικού Ναυτικού (ΑΕΝ)",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε το  επίδομα σίτησης ως σπουδαστής/στρια των Ακαδημιών Εμπορικού Ναυτικού.",
